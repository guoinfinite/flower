...
import com.example.flowers.application.MyDataHelper;
...
public class SelectedFlowerActivity extends BaseActivity implements
    ...
    private void initView() {
        ...
        flower10 = (CheckBox) findViewById(R.id.flower10);
        //复选框改变监听事件
        ...
        flower10.setOnCheckedChangeListener(this);
        //TODO:10种花
        //解锁显示获取隐藏(复选框)
//        if (unlock) {
