package com.example.flowers.ui.activity;
...
import com.example.flowers.application.MyApplication;
import com.example.flowers.db.MyDataUtils;
import com.example.flowers.ui.base.BaseActivity;
import com.example.flowers.ui.bean.Flower;
import com.example.flowers.ui.utils.FileIOUtils;
...
public class ShareActivity extends BaseActivity implements View.OnClickListener{
    ...
    public class WXShareCallBack extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (!Objects.equals(intent.getAction(), "mrkj.flowersdemo.ui.activity.share")){
